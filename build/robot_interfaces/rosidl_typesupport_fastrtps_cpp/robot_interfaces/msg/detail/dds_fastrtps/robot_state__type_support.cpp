...
{
bool cdr_serialize(
  const robot_interfaces::msg::Position &,
  ...
  size_t current_alignment)
{
  ...
  // Member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Position(
  ...
  size_t current_alignment)
{
  ...
  // Member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Position(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
