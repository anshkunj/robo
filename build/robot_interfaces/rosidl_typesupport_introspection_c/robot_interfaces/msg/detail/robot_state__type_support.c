...
// Member `position`
#include "robot_interfaces/msg/position.h"
// Member `position`
...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__msg__RobotState__rosidl_typesupport_introspection_c__RobotState_message_member_array[2] = {
  {
    "position",  // name
    ...
    offsetof(robot_interfaces__msg__RobotState, position),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__msg__RobotState, battery),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
