...
#include "robot_interfaces/msg/detail/position__functions.h"  // position
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: position
  {
    cdr_serialize_robot_interfaces__msg__Position(
  ...
  robot_interfaces__msg__RobotState * ros_message)
{
  // Field name: position
  {
    cdr_deserialize_robot_interfaces__msg__Position(cdr, &ros_message->position);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: position
  current_alignment += get_serialized_size_robot_interfaces__msg__Position(
  ...
  size_t current_alignment)
{
  ...
  // Field name: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robot_interfaces__msg__Position(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: position
  {
    cdr_serialize_key_robot_interfaces__msg__Position(
      &ros_message->position, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: position
  current_alignment += get_serialized_size_key_robot_interfaces__msg__Position(
    &(ros_message->position), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_robot_interfaces__msg__Position(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
