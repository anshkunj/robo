...
{
public:
  explicit Init_RobotState_battery(::robot_interfaces::msg::RobotState & msg)
  : msg_(msg)
  {}
  ::robot_interfaces::msg::RobotState battery(::robot_interfaces::msg::RobotState::_battery_type arg)
  {
...
public:
  ...
  {}
  Init_RobotState_battery position(::robot_interfaces::msg::RobotState::_position_type arg)
  {
...
{
  return robot_interfaces::msg::builder::Init_RobotState_position();
}
