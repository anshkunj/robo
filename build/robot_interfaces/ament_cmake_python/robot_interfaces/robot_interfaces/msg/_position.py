...
class Metaclass_Position(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class PositionConstants(typing.TypedDict):
        pass

    __constants: PositionConstants = {
    }
...
class Position(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Position):
