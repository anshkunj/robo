...
bool robot_interfaces__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_interfaces.msg._robot_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 33) == 0);
  ...
  {  // position
    ...
    if (!robot_interfaces__msg__position__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * robot_interfaces__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // position
    PyObject * field = NULL;
    field = robot_interfaces__msg__position__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
