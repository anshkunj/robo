...
if typing.TYPE_CHECKING:
    import robot_interfaces.msg  # noqa: E402, I100, I201, I300
...
class Metaclass_RobotState(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    def __import_type_support__(cls) -> None:
        try:
            ...
            if Position._TYPE_SUPPORT is None:
                Position.__import_type_support__()
...
class RobotState(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types: dict[str, str] = {
        'position': 'robot_interfaces/Position',
        'battery': 'float',
    }
    ...
    SLOT_TYPES: tuple[rosidl_parser.definition.AbstractType, ...] = (
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'msg'], 'Position'),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
    )

    def __init__(self, *,
                 position: typing.Optional[robot_interfaces.msg.Position] = None,  # noqa: E501
    ...
    @builtins.property
    def position(self) -> robot_interfaces.msg.Position:
        """Message field 'position'."""
        return self._position

    @position.setter
    def position(self, value: robot_interfaces.msg.Position) -> None:
        from robot_interfaces.msg import Position
